    ...
    mapOf(
        ...
        BeamColorVariant.Sunset to
            listOf(
                ...
                BeamBlob(46, 160, 90, 1.000f, 0.0200f, 0.6800f, 9.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(30, 190, 120, 1.000f, 0.0200f, 0.6800f, 4.0f, 8.0f, 3, BeamCorner.Tr),
                BeamBlob(70, 180, 70, 1.000f, 0.7200f, -0.0300f, 59.0f, 9.0f, 3, BeamCorner.Tr),
                BeamBlob(20, 150, 130, 1.000f, 0.7400f, 1.0000f, 42.0f, 7.0f, 3, BeamCorner.Tr),
                BeamBlob(90, 200, 80, 1.000f, 1.0000f, 0.2700f, 10.0f, 17.0f, 3, BeamCorner.Tr),
                BeamBlob(40, 170, 110, 1.000f, 1.0000f, 0.2700f, 10.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(120, 210, 70, 1.000f, 1.0000f, 0.2700f, 5.0f, 10.0f, 3, BeamCorner.Tr),
                BeamBlob(35, 145, 100, 1.000f, 1.0000f, 0.2700f, 11.0f, 12.0f, 3, BeamCorner.Tr),
                BeamBlob(60, 195, 140, 1.000f, 0.0200f, 0.6800f, 9.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(46, 160, 90, 1.000f, 0.0200f, 0.6800f, 4.0f, 8.0f, 3, BeamCorner.Tr),
                BeamBlob(30, 190, 120, 1.000f, 0.7200f, -0.0300f, 59.0f, 9.0f, 3, BeamCorner.Tr),
                BeamBlob(70, 180, 70, 1.000f, 0.7400f, 1.0000f, 42.0f, 7.0f, 3, BeamCorner.Tr),
                BeamBlob(20, 150, 130, 1.000f, 1.0000f, 0.2700f, 10.0f, 17.0f, 3, BeamCorner.Tr),
                BeamBlob(90, 200, 80, 1.000f, 1.0000f, 0.2700f, 10.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(40, 170, 110, 1.000f, 1.0000f, 0.2700f, 5.0f, 10.0f, 3, BeamCorner.Tr),
                BeamBlob(120, 210, 70, 1.000f, 1.0000f, 0.2700f, 11.0f, 12.0f, 3, BeamCorner.Tr),
                BeamBlob(240, 70, 170, 1.000f, 0.0200f, 0.6800f, 9.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(255, 90, 140, 1.000f, 0.0200f, 0.6800f, 4.0f, 8.0f, 3, BeamCorner.Tr),
                BeamBlob(215, 60, 200, 1.000f, 0.7200f, -0.0300f, 59.0f, 9.0f, 3, BeamCorner.Tr),
                BeamBlob(255, 110, 180, 1.000f, 0.7400f, 1.0000f, 42.0f, 7.0f, 3, BeamCorner.Tr),
                BeamBlob(200, 80, 240, 1.000f, 1.0000f, 0.2700f, 10.0f, 17.0f, 3, BeamCorner.Tr),
                BeamBlob(250, 60, 150, 1.000f, 1.0000f, 0.2700f, 10.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(230, 120, 220, 1.000f, 1.0000f, 0.2700f, 5.0f, 10.0f, 3, BeamCorner.Tr),
                BeamBlob(245, 85, 165, 1.000f, 1.0000f, 0.2700f, 11.0f, 12.0f, 3, BeamCorner.Tr),
                BeamBlob(210, 70, 230, 1.000f, 0.0200f, 0.6800f, 9.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(240, 70, 170, 1.000f, 0.0200f, 0.6800f, 4.0f, 8.0f, 3, BeamCorner.Tr),
                BeamBlob(255, 90, 140, 1.000f, 0.7200f, -0.0300f, 59.0f, 9.0f, 3, BeamCorner.Tr),
                BeamBlob(215, 60, 200, 1.000f, 0.7400f, 1.0000f, 42.0f, 7.0f, 3, BeamCorner.Tr),
                BeamBlob(255, 110, 180, 1.000f, 1.0000f, 0.2700f, 10.0f, 17.0f, 3, BeamCorner.Tr),
                BeamBlob(200, 80, 240, 1.000f, 1.0000f, 0.2700f, 10.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(250, 60, 150, 1.000f, 1.0000f, 0.2700f, 5.0f, 10.0f, 3, BeamCorner.Tr),
                BeamBlob(230, 120, 220, 1.000f, 1.0000f, 0.2700f, 11.0f, 12.0f, 3, BeamCorner.Tr),
                BeamBlob(90, 200, 240, 1.000f, 0.0200f, 0.6800f, 9.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(60, 175, 230, 1.000f, 0.0200f, 0.6800f, 4.0f, 8.0f, 3, BeamCorner.Tr),
                BeamBlob(130, 220, 250, 1.000f, 0.7200f, -0.0300f, 59.0f, 9.0f, 3, BeamCorner.Tr),
                BeamBlob(70, 190, 215, 1.000f, 0.7400f, 1.0000f, 42.0f, 7.0f, 3, BeamCorner.Tr),
                BeamBlob(110, 210, 255, 1.000f, 1.0000f, 0.2700f, 10.0f, 17.0f, 3, BeamCorner.Tr),
                BeamBlob(50, 165, 220, 1.000f, 1.0000f, 0.2700f, 10.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(150, 230, 250, 1.000f, 1.0000f, 0.2700f, 5.0f, 10.0f, 3, BeamCorner.Tr),
                BeamBlob(85, 195, 235, 1.000f, 1.0000f, 0.2700f, 11.0f, 12.0f, 3, BeamCorner.Tr),
                BeamBlob(65, 180, 245, 1.000f, 0.0200f, 0.6800f, 9.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(90, 200, 240, 1.000f, 0.0200f, 0.6800f, 4.0f, 8.0f, 3, BeamCorner.Tr),
                BeamBlob(60, 175, 230, 1.000f, 0.7200f, -0.0300f, 59.0f, 9.0f, 3, BeamCorner.Tr),
                BeamBlob(130, 220, 250, 1.000f, 0.7400f, 1.0000f, 42.0f, 7.0f, 3, BeamCorner.Tr),
                BeamBlob(70, 190, 215, 1.000f, 1.0000f, 0.2700f, 10.0f, 17.0f, 3, BeamCorner.Tr),
                BeamBlob(110, 210, 255, 1.000f, 1.0000f, 0.2700f, 10.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(50, 165, 220, 1.000f, 1.0000f, 0.2700f, 5.0f, 10.0f, 3, BeamCorner.Tr),
                BeamBlob(150, 230, 250, 1.000f, 1.0000f, 0.2700f, 11.0f, 12.0f, 3, BeamCorner.Tr),
                BeamBlob(240, 190, 60, 1.000f, 0.0200f, 0.6800f, 9.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(255, 210, 90, 1.000f, 0.0200f, 0.6800f, 4.0f, 8.0f, 3, BeamCorner.Tr),
                BeamBlob(225, 165, 40, 1.000f, 0.7200f, -0.0300f, 59.0f, 9.0f, 3, BeamCorner.Tr),
                BeamBlob(250, 200, 70, 1.000f, 0.7400f, 1.0000f, 42.0f, 7.0f, 3, BeamCorner.Tr),
                BeamBlob(255, 225, 120, 1.000f, 1.0000f, 0.2700f, 10.0f, 17.0f, 3, BeamCorner.Tr),
                BeamBlob(230, 175, 50, 1.000f, 1.0000f, 0.2700f, 10.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(245, 205, 85, 1.000f, 1.0000f, 0.2700f, 5.0f, 10.0f, 3, BeamCorner.Tr),
                BeamBlob(215, 155, 35, 1.000f, 1.0000f, 0.2700f, 11.0f, 12.0f, 3, BeamCorner.Tr),
                BeamBlob(255, 215, 100, 1.000f, 0.0200f, 0.6800f, 9.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(240, 190, 60, 1.000f, 0.0200f, 0.6800f, 4.0f, 8.0f, 3, BeamCorner.Tr),
                BeamBlob(255, 210, 90, 1.000f, 0.7200f, -0.0300f, 59.0f, 9.0f, 3, BeamCorner.Tr),
                BeamBlob(225, 165, 40, 1.000f, 0.7400f, 1.0000f, 42.0f, 7.0f, 3, BeamCorner.Tr),
                BeamBlob(250, 200, 70, 1.000f, 1.0000f, 0.2700f, 10.0f, 17.0f, 3, BeamCorner.Tr),
                BeamBlob(255, 225, 120, 1.000f, 1.0000f, 0.2700f, 10.0f, 18.0f, 3, BeamCorner.Tr),
                BeamBlob(230, 175, 50, 1.000f, 1.0000f, 0.2700f, 5.0f, 10.0f, 3, BeamCorner.Tr),
                BeamBlob(245, 205, 85, 1.000f, 1.0000f, 0.2700f, 11.0f, 12.0f, 3, BeamCorner.Tr),
            ),
    )
    ...
    mapOf(
        ...
        (BeamColorVariant.Sunset to BeamTheme.Light) to
            listOf(
                ...
                LineSpot(46, 160, 90, 36.0f, 36.0f, 0.0f, 2.0f),
                LineSpot(30, 190, 120, 30.0f, 32.0f, 39.0f, 0.0f),
                LineSpot(70, 180, 70, 33.0f, 28.0f, -36.0f, 2.0f),
                LineSpot(20, 150, 130, 29.0f, 34.0f, -54.0f, 0.0f),
                LineSpot(90, 200, 80, 27.0f, 30.0f, 51.0f, -1.0f),
                LineSpot(40, 170, 110, 36.0f, 24.0f, 21.0f, 1.0f),
                LineSpot(120, 210, 70, 30.0f, 22.0f, -21.0f, 0.0f),
                LineSpot(35, 145, 100, 25.0f, 28.0f, 66.0f, 1.0f),
                LineSpot(60, 195, 140, 23.0f, 30.0f, -66.0f, -1.0f),
                LineSpot(33, 115, 65, 45.0f, 36.0f, 0.0f, 2.0f),
                LineSpot(22, 137, 86, 35.0f, 32.0f, 65.0f, 0.0f),
                LineSpot(50, 130, 50, 40.0f, 28.0f, -60.0f, 2.0f),
                LineSpot(14, 108, 94, 35.0f, 34.0f, -90.0f, 0.0f),
                LineSpot(65, 144, 58, 38.0f, 30.0f, 85.0f, -1.0f),
                LineSpot(29, 122, 79, 50.0f, 24.0f, 35.0f, 1.0f),
                LineSpot(86, 151, 50, 40.0f, 22.0f, -35.0f, 0.0f),
                LineSpot(25, 104, 72, 35.0f, 28.0f, 110.0f, 1.0f),
                LineSpot(43, 140, 101, 30.0f, 30.0f, -110.0f, -1.0f),
                LineSpot(240, 70, 170, 36.0f, 36.0f, 0.0f, 2.0f),
                LineSpot(255, 90, 140, 30.0f, 32.0f, 39.0f, 0.0f),
                LineSpot(215, 60, 200, 33.0f, 28.0f, -36.0f, 2.0f),
                LineSpot(255, 110, 180, 29.0f, 34.0f, -54.0f, 0.0f),
                LineSpot(200, 80, 240, 27.0f, 30.0f, 51.0f, -1.0f),
                LineSpot(250, 60, 150, 36.0f, 24.0f, 21.0f, 1.0f),
                LineSpot(230, 120, 220, 30.0f, 22.0f, -21.0f, 0.0f),
                LineSpot(245, 85, 165, 25.0f, 28.0f, 66.0f, 1.0f),
                LineSpot(210, 70, 230, 23.0f, 30.0f, -66.0f, -1.0f),
                LineSpot(173, 50, 122, 45.0f, 36.0f, 0.0f, 2.0f),
                LineSpot(184, 65, 101, 35.0f, 32.0f, 65.0f, 0.0f),
                LineSpot(155, 43, 144, 40.0f, 28.0f, -60.0f, 2.0f),
                LineSpot(184, 79, 130, 35.0f, 34.0f, -90.0f, 0.0f),
                LineSpot(144, 58, 173, 38.0f, 30.0f, 85.0f, -1.0f),
                LineSpot(180, 43, 108, 50.0f, 24.0f, 35.0f, 1.0f),
                LineSpot(166, 86, 158, 40.0f, 22.0f, -35.0f, 0.0f),
                LineSpot(176, 61, 119, 35.0f, 28.0f, 110.0f, 1.0f),
                LineSpot(151, 50, 166, 30.0f, 30.0f, -110.0f, -1.0f),
                LineSpot(90, 200, 240, 36.0f, 36.0f, 0.0f, 2.0f),
                LineSpot(60, 175, 230, 30.0f, 32.0f, 39.0f, 0.0f),
                LineSpot(130, 220, 250, 33.0f, 28.0f, -36.0f, 2.0f),
                LineSpot(70, 190, 215, 29.0f, 34.0f, -54.0f, 0.0f),
                LineSpot(110, 210, 255, 27.0f, 30.0f, 51.0f, -1.0f),
                LineSpot(50, 165, 220, 36.0f, 24.0f, 21.0f, 1.0f),
                LineSpot(150, 230, 250, 30.0f, 22.0f, -21.0f, 0.0f),
                LineSpot(85, 195, 235, 25.0f, 28.0f, 66.0f, 1.0f),
                LineSpot(65, 180, 245, 23.0f, 30.0f, -66.0f, -1.0f),
                LineSpot(65, 144, 173, 45.0f, 36.0f, 0.0f, 2.0f),
                LineSpot(43, 126, 166, 35.0f, 32.0f, 65.0f, 0.0f),
                LineSpot(94, 158, 180, 40.0f, 28.0f, -60.0f, 2.0f),
                LineSpot(50, 137, 155, 35.0f, 34.0f, -90.0f, 0.0f),
                LineSpot(79, 151, 184, 38.0f, 30.0f, 85.0f, -1.0f),
                LineSpot(36, 119, 158, 50.0f, 24.0f, 35.0f, 1.0f),
                LineSpot(108, 166, 180, 40.0f, 22.0f, -35.0f, 0.0f),
                LineSpot(61, 140, 169, 35.0f, 28.0f, 110.0f, 1.0f),
                LineSpot(47, 130, 176, 30.0f, 30.0f, -110.0f, -1.0f),
                LineSpot(240, 190, 60, 36.0f, 36.0f, 0.0f, 2.0f),
                LineSpot(255, 210, 90, 30.0f, 32.0f, 39.0f, 0.0f),
                LineSpot(225, 165, 40, 33.0f, 28.0f, -36.0f, 2.0f),
                LineSpot(250, 200, 70, 29.0f, 34.0f, -54.0f, 0.0f),
                LineSpot(255, 225, 120, 27.0f, 30.0f, 51.0f, -1.0f),
                LineSpot(230, 175, 50, 36.0f, 24.0f, 21.0f, 1.0f),
                LineSpot(245, 205, 85, 30.0f, 22.0f, -21.0f, 0.0f),
                LineSpot(215, 155, 35, 25.0f, 28.0f, 66.0f, 1.0f),
                LineSpot(255, 215, 100, 23.0f, 30.0f, -66.0f, -1.0f),
                LineSpot(173, 137, 43, 45.0f, 36.0f, 0.0f, 2.0f),
                LineSpot(184, 151, 65, 35.0f, 32.0f, 65.0f, 0.0f),
                LineSpot(162, 119, 29, 40.0f, 28.0f, -60.0f, 2.0f),
                LineSpot(180, 144, 50, 35.0f, 34.0f, -90.0f, 0.0f),
                LineSpot(184, 162, 86, 38.0f, 30.0f, 85.0f, -1.0f),
                LineSpot(166, 126, 36, 50.0f, 24.0f, 35.0f, 1.0f),
                LineSpot(176, 148, 61, 40.0f, 22.0f, -35.0f, 0.0f),
                LineSpot(155, 112, 25, 35.0f, 28.0f, 110.0f, 1.0f),
                LineSpot(184, 155, 72, 30.0f, 30.0f, -110.0f, -1.0f),
            ),
    )
